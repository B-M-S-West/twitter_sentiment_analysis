...
def create_sentiment_image(positivity:float, image_size: tuple[int, int]) -> np.ndarray:
    """
    Creates an image based on the positivity score.
    This draws a smiley with expression based on the positivtiy score.
    ...
    mouth_left = (center[0] - mouth_width, center[1] + mouth_offset_y)
    mouth_right = (center[0] + mouth_width, center[1] + mouth_offset_y)
